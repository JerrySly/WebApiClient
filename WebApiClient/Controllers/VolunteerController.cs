...
namespace WebApiClient.Controllers
{
    ...
    {
        ElementService<Volunteer,DTOVolunteer> _service = new ElementService<Volunteer, DTOVolunteer>();
        ...
        [HttpPost]
        public async Task<ActionResult> Create(Volunteer element)
        {
            if (element.Id == 0)
            {
        ...
        public ActionResult Edit(int id, Volunteer element)
        {
